<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"E:\fastadmin\public/../application/admin\view\kaoshi\examination\questions\index.html";i:1605241810;s:55:"E:\fastadmin\application\admin\view\layout\default.html";i:1605241810;s:52:"E:\fastadmin\application\admin\view\common\meta.html";i:1605241810;s:54:"E:\fastadmin\application\admin\view\common\script.html";i:1605241810;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a class="btn btn-success btn-recyclebin btn-dialog <?php echo $auth->check('kaoshi/examination/questions/recyclebin')?'':'hide'; ?>" href="kaoshi/examination/questions/recyclebin" title="<?php echo __('Recycle bin'); ?>"><i class="fa fa-recycle"></i> <?php echo __('Recycle bin'); ?></a>
                    </div>
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('kaoshi/examination/questions/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('kaoshi/examination/questions/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
