define(['jquery', 'bootstrap', 'plupload', 'template'], function ($, undefined, Plupload, Template) {
    var Upload = {
            ...
            config: {
                ...
                previewtpl: '<li class="col-xs-3"><a href="<%=fullurl%>" data-url="<%=url%>" target="_blank" class="thumbnail"><img src="<%=showimg%>" onerror="this.src=\'' + Fast.api.fixurl("ajax/icon") + '?suffix=<%=suffix%>\';this.onerror=null;" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa fa-trash"></i></a></li>',
            },
            events: {
                onInit: function (up) {
                    //修复少数安卓浏览器无法上传图片的Bug
                        ...
                        if (preview_id && input_id) {
                            $(document.body).on("keyup change", "#" + input_id, function (e) {
                                ...
                                $.each(inputArr, function (i, j) {
                                    ...
                                    var showimg = 'http://admin.fastadmin.com/index/index/img?src='+j;
                                    var data = {url: j, fullurl: Fast.api.cdnurl(j),showimg:showimg, data: $(that).data(), key: i, index: i, value: (json && typeof json[i] !== 'undefined' ? json[i] : null), suffix: suffix};
